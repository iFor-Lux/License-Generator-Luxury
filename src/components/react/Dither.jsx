...
float pattern(vec2 p) {
  // USANDO LAS VARIABLES GLOBALES DEL SHADER DIRECTAMENTE
...
function DitheredWaves({
  ...
  useFrame((state) => {
    ...
    // Forzamos actualización de resolución en cada frame para seguridad
    u.resolution.value.set(size.width * dpr, size.height * dpr);
    
    // Forzamos actualización de tiempo ignorando cualquier flag
